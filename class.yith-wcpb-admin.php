    ...
    class YITH_WCPB_Admin {
        ...
        public function yith_wcpb_admin_product_bundle_data( $metabox_id, $product_id, $item_data, $post_id ) {
            ...
            <table>
                <tr>
                    ...
                    <td><input type="number" size="4" value="<?php echo $bp_quantity ?>" name="_yith_wcpb_bundle_data[<?php echo $metabox_id; ?>][bp_quantity]"
        ...
        public function register_panel() {
            ...
            $admin_tabs_free = array(
                //'settings'      => __( 'Settings', 'yith-woocommerce-product-bundles' ),
